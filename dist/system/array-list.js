...
System.register(["./array-iterator"], function (_export, _context) {
    "use strict";

    var ArrayIterator, ArrayList;
    ...
    return {
        setters: [function (_arrayIterator) {
            ArrayIterator = _arrayIterator.ArrayIterator;
        }],
        execute: function () {
            _export("ArrayList", ArrayList = function () {
                function ArrayList() {
